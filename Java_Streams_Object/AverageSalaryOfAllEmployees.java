...
public class AverageSalaryOfAllEmployees {
	
	// ========================================================================
	// PROBLEM : Average Salary of All Employees
	// ========================================================================
	/*
	 * Problem Statement: Find average salary of employees.
	 * 
	 * Approach: Use mapToDouble() and average().
	 * Time Complexity: O(n)
	...
	public static void main(String[] args) {
		...
		double averageSal = employees.stream().mapToDouble(Employee::getSalary).average().orElse(0.0);
